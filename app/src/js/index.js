...
ScrollReveal().reveal('.participate__list-item', {duration: 1000, distance: "50px", viewOffset: { bottom: 200 }, interval: 300, origin: 'right'});
ScrollReveal().reveal('.sponsors__image', {delay: 300, duration: 1000, distance: "50px", viewOffset: { bottom: 200 }, interval: 300});
